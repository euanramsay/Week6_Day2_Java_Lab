...
public class BearTest{
  ...
  public void canGetChickenBack() {
    ...
    assertEquals("cluck", original.speak());
  }
  ...
  @Test
  public void foodNutritionValue(){
    assertEquals(7, chicken.nutritionValue());
  }

@Test
public void totalBellyNutrition(){
  bear.eat(chicken);
  bear.eat(human);
  bear.eat(salmon);
  assertEquals(22, bear.totalNutrition());
}
}
